print("Seja bem vindo a nossa calculadora fitness, avalie o |MENU| de escolhas e faça sua. Mas antes me diga essas informações.")
...
while True:
    ...
    if opcoes == 1:
        ...
        if calculo_de_imc < 18.5:
            print(f"O seu IMC é {calculo_de_imc: .2f}", " você está com peso inferior.")
        elif calculo_de_imc >= 18.5 and calculo_de_imc <= 24.9:
            print(f"O seu IMC é {calculo_de_imc: .2f}", " você está com o peso ideal.")
        elif calculo_de_imc >= 25 and calculo_de_imc <= 29.9:
            print(f"O seu IMC é {calculo_de_imc: .2f}",  " você está com sobrepeso")
        elif calculo_de_imc >= 30 and calculo_de_imc <= 34.9:
            print(f"O seu IMC é {calculo_de_imc: .2f}", " você está com obesidade")
        elif calculo_de_imc > 35:
            print(f"O seu IMC é {calculo_de_imc: .2f}", " você está com obesidade extrema")
    ...
    #seu resumo diario
        ...
        print("Esses são os valores de intensidade média de cada atividade física, digite o número de qual você práticou.")
        print("1- Descanso")
        print("2- Caminhada")
        print("3- Caminhada rapida")
        print("7- Esportes")
